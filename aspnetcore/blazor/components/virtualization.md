...
Die Höhe jedes Elements in Pixeln kann mit <xref:Microsoft.AspNetCore.Components.Web.Virtualization.Virtualize%601.ItemSize%2A?displayProperty=nameWithType> festgelegt werden (Standardwert: 50):
