...
<span data-ttu-id="bd6ef-187">Das Speichern von Kenn Wörtern im Klartext ist unsicher.</span><span class="sxs-lookup"><span data-stu-id="bd6ef-187">Storing passwords in plain text is insecure.</span></span> <span data-ttu-id="bd6ef-188">Beispielsweise kann eine Datenbank-Verbindungs Zeichenfolge, die in gespeichert ist, *appsettings.json* ein Kennwort für den angegebenen Benutzer enthalten:</span><span class="sxs-lookup"><span data-stu-id="bd6ef-188">For example, a database connection string stored in *appsettings.json* may include a password for the specified user:</span></span>
...
<span data-ttu-id="bd6ef-191">Entfernen Sie das `Password` Schlüssel-Wert-Paar aus der Verbindungs Zeichenfolge in *appsettings.json* .</span><span class="sxs-lookup"><span data-stu-id="bd6ef-191">Remove the `Password` key-value pair from the connection string in *appsettings.json* .</span></span> <span data-ttu-id="bd6ef-192">Zum Beispiel:</span><span class="sxs-lookup"><span data-stu-id="bd6ef-192">For example:</span></span>
...
<span data-ttu-id="bd6ef-290">Das Speichern von Kenn Wörtern im Klartext ist unsicher.</span><span class="sxs-lookup"><span data-stu-id="bd6ef-290">Storing passwords in plain text is insecure.</span></span> <span data-ttu-id="bd6ef-291">Beispielsweise kann eine Datenbank-Verbindungs Zeichenfolge, die in gespeichert ist, *appsettings.json* ein Kennwort für den angegebenen Benutzer enthalten:</span><span class="sxs-lookup"><span data-stu-id="bd6ef-291">For example, a database connection string stored in *appsettings.json* may include a password for the specified user:</span></span>
...
<span data-ttu-id="bd6ef-294">Entfernen Sie das `Password` Schlüssel-Wert-Paar aus der Verbindungs Zeichenfolge in *appsettings.json* .</span><span class="sxs-lookup"><span data-stu-id="bd6ef-294">Remove the `Password` key-value pair from the connection string in *appsettings.json* .</span></span> <span data-ttu-id="bd6ef-295">Zum Beispiel:</span><span class="sxs-lookup"><span data-stu-id="bd6ef-295">For example:</span></span>
