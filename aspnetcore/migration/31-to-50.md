...
>
> Die Möglichkeit, auf festzulegen `PreferExactMatches` `@false` oder nicht festzulegen, wobei die Option standardmäßig `false` in c# verwendet *wird, wird nur aus Gründen der Abwärtskompatibilität bereitgestellt*.
>
