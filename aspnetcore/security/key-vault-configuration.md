...
<span data-ttu-id="d60a3-381">Das X. 509-Zertifikat wird vom Betriebssystem verwaltet.</span><span class="sxs-lookup"><span data-stu-id="d60a3-381">The X.509 certificate is managed by the OS.</span></span> <span data-ttu-id="d60a3-382">Die App Ruft <xref:Microsoft.Extensions.Configuration.AzureKeyVaultConfigurationExtensions.AddAzureKeyVault*> mit Werten auf, die von der Datei bereitgestellt werden *:::no-loc(appsettings.json):::* :</span><span class="sxs-lookup"><span data-stu-id="d60a3-382">The app calls <xref:Microsoft.Extensions.Configuration.AzureKeyVaultConfigurationExtensions.AddAzureKeyVault*> with values supplied by the *:::no-loc(appsettings.json):::* file:</span></span>
...
<span data-ttu-id="d60a3-387">*:::no-loc(appsettings.json):::* :</span><span class="sxs-lookup"><span data-stu-id="d60a3-387">*:::no-loc(appsettings.json):::* :</span></span>
...
<span data-ttu-id="d60a3-394">Geben Sie den Tresor Namen in die Datei der APP ein *:::no-loc(appsettings.json):::* .</span><span class="sxs-lookup"><span data-stu-id="d60a3-394">Enter the vault name into the app's *:::no-loc(appsettings.json):::* file.</span></span> <span data-ttu-id="d60a3-395">Die Beispiel-App erfordert keine Anwendungs-ID und kein Kennwort (geheimer Client Schlüssel), wenn Sie auf die-Version festgelegt `Managed` ist, sodass Sie diese Konfigurationseinträge ignorieren können.</span><span class="sxs-lookup"><span data-stu-id="d60a3-395">The sample app doesn't require an Application ID and Password (Client Secret) when set to the `Managed` version, so you can ignore those configuration entries.</span></span> <span data-ttu-id="d60a3-396">Die APP wird in Azure bereitgestellt, und Azure authentifiziert die APP für den Zugriff auf Azure Key Vault nur mithilfe des Tresor namens, der in der Datei gespeichert ist *:::no-loc(appsettings.json):::* .</span><span class="sxs-lookup"><span data-stu-id="d60a3-396">The app is deployed to Azure, and Azure authenticates the app to access Azure Key Vault only using the vault name stored in the *:::no-loc(appsettings.json):::* file.</span></span>
...
<span data-ttu-id="d60a3-409">*:::no-loc(appsettings.json):::* :</span><span class="sxs-lookup"><span data-stu-id="d60a3-409">*:::no-loc(appsettings.json):::* :</span></span>
