...
Wenn die APP den Host mit `ConfigureWebHost` anstelle von manuell erstellt `ConfigureWebHostDefaults` , müssen Sie `UseKestrel` auf dem Webhost-Generator aufzurufen:
