<span data-ttu-id="a0cbd-101">Die `FetchData`-Komponente zeigt Folgendes:</span><span class="sxs-lookup"><span data-stu-id="a0cbd-101">The `FetchData` component shows how to:</span></span>
