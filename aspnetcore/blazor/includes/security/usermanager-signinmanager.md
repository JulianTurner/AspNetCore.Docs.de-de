...
* <xref:Microsoft.AspNetCore.Identity.IdentityUser>-Details wie Benutzername, E-Mail-Adresse oder Ende der Sperrung.
...
In den folgenden `WeatherForecastController`-Protokollen wird der <xref:Microsoft.AspNetCore.Identity.IdentityUser%601.UserName> protokolliert, wenn die `Get`-Methode aufgerufen wird:
