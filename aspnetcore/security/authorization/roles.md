...
<span data-ttu-id="100f6-117">Für- Razor Seiten kann auf Folgendes `AuthorizeAttribute` angewendet werden:</span><span class="sxs-lookup"><span data-stu-id="100f6-117">For Razor Pages, the `AuthorizeAttribute` can be applied by either:</span></span>
...
### <a name="add-role-services-to-no-locidentity"></a><span data-ttu-id="100f6-127">Rollen Dienste hinzufügen zu Identity</span><span class="sxs-lookup"><span data-stu-id="100f6-127">Add Role services to Identity</span></span>
