...
Erstellen Sie einen Mandanten, oder identifizieren Sie einen vorhandenen B2C-Mandanten für die App, die im Azure-Portal verwendet werden soll. Befolgen Sie hierzu die Anweisungen im Tutorial [Erstellen eines Azure Active Directory B2C-Mandanten](/azure/active-directory-b2c/tutorial-create-tenant).
...
Registrieren Sie eine AAD B2C-App (zugehöriger Leitfaden in der Azure-Dokumentation: [Tutorial: Registrieren einer Webanwendung in Azure Active Directory B2C](/azure/active-directory-b2c/tutorial-register-applications)):
