...
Eine Einführung in die Authentifizierungs Schemas in ASP.net Core finden Sie unter [Authentifizierungsschema](xref:security/authentication/index#authentication-scheme).
