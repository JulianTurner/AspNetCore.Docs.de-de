...
* <span data-ttu-id="65e26-133">[Aktionsfilter](#action-filters):</span><span class="sxs-lookup"><span data-stu-id="65e26-133">[Action filters](#action-filters):</span></span>
  ...
  * <span data-ttu-id="65e26-137">Werden in Seiten **nicht** unterstützt :::no-loc(Razor)::: .</span><span class="sxs-lookup"><span data-stu-id="65e26-137">Are **not** supported in :::no-loc(Razor)::: Pages.</span></span>
...
<span data-ttu-id="65e26-183">Der folgende Code wendet `MyActionFilterAttribute` und `AddHeaderAttribute` auf die Seite an :::no-loc(Razor)::: :</span><span class="sxs-lookup"><span data-stu-id="65e26-183">The following code applies the `MyActionFilterAttribute` and the `AddHeaderAttribute` to the :::no-loc(Razor)::: Page:</span></span>

[!code-csharp[](filters/3.1sample/FiltersSample/Pages/Movies/Index.cshtml.cs?name=snippet)]

<span data-ttu-id="65e26-184">Filter können nicht auf :::no-loc(Razor)::: seitenhandlermethoden angewendet werden.</span><span class="sxs-lookup"><span data-stu-id="65e26-184">Filters cannot be applied to :::no-loc(Razor)::: Page handler methods.</span></span> <span data-ttu-id="65e26-185">Sie können entweder auf das :::no-loc(Razor)::: Seiten Modell oder Global angewendet werden.</span><span class="sxs-lookup"><span data-stu-id="65e26-185">They can be applied either to the :::no-loc(Razor)::: Page model or globally.</span></span>
...
* <span data-ttu-id="65e26-190">Verwenden eines Attributs für eine Controller-Aktion.</span><span class="sxs-lookup"><span data-stu-id="65e26-190">Using an attribute on a controller action.</span></span> <span data-ttu-id="65e26-191">Filter Attribute können nicht auf :::no-loc(Razor)::: Seiten Handlermethoden angewendet werden.</span><span class="sxs-lookup"><span data-stu-id="65e26-191">Filter attributes cannot be applied to :::no-loc(Razor)::: Pages handler methods.</span></span>
* <span data-ttu-id="65e26-192">Verwenden eines Attributs auf einem Controller oder einer :::no-loc(Razor)::: Seite.</span><span class="sxs-lookup"><span data-stu-id="65e26-192">Using an attribute on a controller or :::no-loc(Razor)::: Page.</span></span>
* <span data-ttu-id="65e26-193">Global für alle Controller, Aktionen und :::no-loc(Razor)::: Seiten, wie im folgenden Code gezeigt:</span><span class="sxs-lookup"><span data-stu-id="65e26-193">Globally for all controllers, actions, and :::no-loc(Razor)::: Pages as shown in the following code:</span></span>
...
* <span data-ttu-id="65e26-199">Der Code von globalen Filtern, der *vor* einer Pipelinephase ausgeführt werden soll</span><span class="sxs-lookup"><span data-stu-id="65e26-199">The *before* code of global filters.</span></span>
  * <span data-ttu-id="65e26-200">Der *vor* -Code von Controller-und :::no-loc(Razor)::: Seiten filtern.</span><span class="sxs-lookup"><span data-stu-id="65e26-200">The *before* code of controller and :::no-loc(Razor)::: Page filters.</span></span>
  ...
  * <span data-ttu-id="65e26-203">Der *after* -Code von Controller-und :::no-loc(Razor)::: Seiten filtern.</span><span class="sxs-lookup"><span data-stu-id="65e26-203">The *after* code of controller and :::no-loc(Razor)::: Page filters.</span></span>
...
| <span data-ttu-id="65e26-211">2</span><span class="sxs-lookup"><span data-stu-id="65e26-211">2</span></span> | <span data-ttu-id="65e26-212">Controller oder :::no-loc(Razor)::: Seite</span><span class="sxs-lookup"><span data-stu-id="65e26-212">Controller or :::no-loc(Razor)::: Page</span></span>| `OnActionExecuting` |
...
| <span data-ttu-id="65e26-217">5</span><span class="sxs-lookup"><span data-stu-id="65e26-217">5</span></span> | <span data-ttu-id="65e26-218">Controller oder :::no-loc(Razor)::: Seite</span><span class="sxs-lookup"><span data-stu-id="65e26-218">Controller or :::no-loc(Razor)::: Page</span></span> | `OnActionExecuted` |
...
<span data-ttu-id="65e26-237">Informationen zu :::no-loc(Razor)::: Seiten finden Sie unter [Implementieren von Seiten :::no-loc(Razor)::: Filtern durch Überschreiben von Filter Methoden](xref:razor-pages/filter#implement-razor-page-filters-by-overriding-filter-methods).</span><span class="sxs-lookup"><span data-stu-id="65e26-237">For :::no-loc(Razor)::: Pages, see [Implement :::no-loc(Razor)::: Page filters by overriding filter methods](xref:razor-pages/filter#implement-razor-page-filters-by-overriding-filter-methods).</span></span>
...
<span data-ttu-id="65e26-341">Aktionsfilter gelten **nicht** für :::no-loc(Razor)::: Seiten.</span><span class="sxs-lookup"><span data-stu-id="65e26-341">Action filters do **not** apply to :::no-loc(Razor)::: Pages.</span></span> <span data-ttu-id="65e26-342">:::no-loc(Razor)::: -Seiten unterstützen <xref:Microsoft.AspNetCore.Mvc.Filters.IPageFilter> und <xref:Microsoft.AspNetCore.Mvc.Filters.IAsyncPageFilter> .</span><span class="sxs-lookup"><span data-stu-id="65e26-342">:::no-loc(Razor)::: Pages supports <xref:Microsoft.AspNetCore.Mvc.Filters.IPageFilter> and <xref:Microsoft.AspNetCore.Mvc.Filters.IAsyncPageFilter> .</span></span> <span data-ttu-id="65e26-343">Weitere Informationen finden Sie unter [Filtermethoden für :::no-loc(Razor)::: Pages](xref:razor-pages/filter).</span><span class="sxs-lookup"><span data-stu-id="65e26-343">For more information, see [Filter methods for :::no-loc(Razor)::: Pages](xref:razor-pages/filter).</span></span>
...
* <span data-ttu-id="65e26-387">Behandeln von nicht behandelten Ausnahmen, die bei der :::no-loc(Razor)::: Erstellung von Seiten oder Controllern, [Modell Bindungen](xref:mvc/models/model-binding), Aktions filtern oder Aktionsmethoden auftreten.</span><span class="sxs-lookup"><span data-stu-id="65e26-387">Handle unhandled exceptions that occur in :::no-loc(Razor)::: Page or controller creation, [model binding](xref:mvc/models/model-binding), action filters, or action methods.</span></span>
...
* <span data-ttu-id="65e26-471">Weitere Informationen finden Sie unter [Filter Methoden für :::no-loc(Razor)::: Seiten](xref:razor-pages/filter).</span><span class="sxs-lookup"><span data-stu-id="65e26-471">See [Filter methods for :::no-loc(Razor)::: Pages](xref:razor-pages/filter).</span></span>
...
<span data-ttu-id="65e26-482">Dieses Dokument gilt für :::no-loc(Razor)::: Seiten, API-Controller und Controller mit Ansichten.</span><span class="sxs-lookup"><span data-stu-id="65e26-482">This document applies to :::no-loc(Razor)::: Pages, API controllers, and controllers with views.</span></span>
...
### <a name="controller-and-no-locrazor-page-level-filters"></a><span data-ttu-id="65e26-568">Filter auf Controller-und :::no-loc(Razor)::: Seitenebene</span><span class="sxs-lookup"><span data-stu-id="65e26-568">Controller and :::no-loc(Razor)::: Page level filters</span></span>
...
<span data-ttu-id="65e26-581">Informationen zu :::no-loc(Razor)::: Seiten finden Sie unter [Implementieren von Seiten :::no-loc(Razor)::: Filtern durch Überschreiben von Filter Methoden](xref:razor-pages/filter#implement-razor-page-filters-by-overriding-filter-methods).</span><span class="sxs-lookup"><span data-stu-id="65e26-581">For :::no-loc(Razor)::: Pages, see [Implement :::no-loc(Razor)::: Page filters by overriding filter methods](xref:razor-pages/filter#implement-razor-page-filters-by-overriding-filter-methods).</span></span>
...
> [!IMPORTANT]
> <span data-ttu-id="65e26-703">Aktionsfilter gelten **nicht** für :::no-loc(Razor)::: Seiten.</span><span class="sxs-lookup"><span data-stu-id="65e26-703">Action filters do **not** apply to :::no-loc(Razor)::: Pages.</span></span> <span data-ttu-id="65e26-704">:::no-loc(Razor)::: -Seiten unterstützen <xref:Microsoft.AspNetCore.Mvc.Filters.IPageFilter> und <xref:Microsoft.AspNetCore.Mvc.Filters.IAsyncPageFilter> .</span><span class="sxs-lookup"><span data-stu-id="65e26-704">:::no-loc(Razor)::: Pages supports <xref:Microsoft.AspNetCore.Mvc.Filters.IPageFilter> and <xref:Microsoft.AspNetCore.Mvc.Filters.IAsyncPageFilter> .</span></span> <span data-ttu-id="65e26-705">Weitere Informationen finden Sie unter [Filtermethoden für :::no-loc(Razor)::: Pages](xref:razor-pages/filter).</span><span class="sxs-lookup"><span data-stu-id="65e26-705">For more information, see [Filter methods for :::no-loc(Razor)::: Pages](xref:razor-pages/filter).</span></span>
...
* <span data-ttu-id="65e26-746">Behandeln von nicht behandelten Ausnahmen, die bei der :::no-loc(Razor)::: Erstellung von Seiten oder Controllern, [Modell Bindungen](xref:mvc/models/model-binding), Aktions filtern oder Aktionsmethoden auftreten.</span><span class="sxs-lookup"><span data-stu-id="65e26-746">Handle unhandled exceptions that occur in :::no-loc(Razor)::: Page or controller creation, [model binding](xref:mvc/models/model-binding), action filters, or action methods.</span></span>
...
* <span data-ttu-id="65e26-829">Weitere Informationen finden Sie unter [Filter Methoden für :::no-loc(Razor)::: Seiten](xref:razor-pages/filter).</span><span class="sxs-lookup"><span data-stu-id="65e26-829">See [Filter methods for :::no-loc(Razor)::: Pages](xref:razor-pages/filter).</span></span>
